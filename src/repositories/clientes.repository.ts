...
export class ClientesRepository extends DefaultCrudRepository<
  Clientes,
  typeof Clientes.prototype.Identificacion,
  ClientesRelations
> {

  public readonly ventaServicios: HasManyRepositoryFactory<VentaServicio, typeof Clientes.prototype.Identificacion>;
